...
var c_cppHighlightRules = function() {
    ...
    var storageType = (
        ...
        "_Imaginary|int|long|short|signed|struct|typedef|union|unsigned|void|String|" +
    ...
    this.$rules = { 
        "start" : [
            ...
            DocCommentHighlightRules.getStartRule("doc-start"),
            {
                ...
                regex : "#\\s*(?:include|import|pragma|line|define|undef|OUTPUT|INPUT|HIGH|LOW)\\b",
                next  : "directive"
            }, {
                ...
                regex : cFunctions + "|pinMode|digitalWrite|analogWrite|digitalRead|analogRead|SoftwareSerial|ESP8266|init|backlight|setCursor|print|tone|delay|delayMicroseconds|pulseIn|readTemperature|readHumidity|computeHeatIndex|attach|write|setSpeed|step"
            }, {
                token : keywordMapper,
