...
Blockly.JavaScript['controls_whileUntil'] = function(block) {
  ...
  return 'while (' + argument0 + ') {loopstep();\n' + branch + '}loopend();\n';
};
...
Blockly.JavaScript['range1'] = function(block) {
    // TODO: Assemble JavaScript into code variable.
    var start = Blockly.JavaScript.valueToCode(block, 'START', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
    var stop = Blockly.JavaScript.valueToCode(block, 'STOP', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
...
Blockly.JavaScript['range2'] = function(block) {
    ...
    var start = Blockly.JavaScript.valueToCode(block, 'START', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
    var stop = Blockly.JavaScript.valueToCode(block, 'STOP', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
    var step = Blockly.JavaScript.valueToCode(block, 'STEP', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
...
Blockly.JavaScript['for_loop'] = function(block) {
  ...
  var variable0 = Blockly.JavaScript.valueToCode(block, 'VAR',  Blockly.JavaScript.ORDER_ASSIGNMENT);
...
Blockly.JavaScript['for_loop2'] = function(block) {
  ...
  var loopVar = Blockly.JavaScript.valueToCode(block, 'VAR',  Blockly.JavaScript.ORDER_ASSIGNMENT);
...
Blockly.JavaScript['while_loop'] = function(block) {
    var conditionCode = Blockly.JavaScript.valueToCode(block, 'WHILE', Blockly.JavaScript.ORDER_NONE) || 'False';
    var branch = Blockly.JavaScript.statementToCode(block, 'DO');
    branch = Blockly.JavaScript.addLoopTrap(branch, block);

    var code = 'while(isProgramRunning() == true && ' + conditionCode + ') {' +
    'loopstep();' +
      branch + 
    '}'+ 
    'loopend();';  
