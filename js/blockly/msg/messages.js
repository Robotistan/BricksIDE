...
Blockly.Msg.DELETE_ALL_BLOCKS = '%1 bloğun hepsi silinsin mi?';
/**
 * @const
 */
/// context menu - Reposition all the blocks so that they form a neat line.
Blockly.Msg.CLEAN_UP = 'Blokları Hizala';
/**
 * @const
 */
...
Blockly.Msg.RENAME_VARIABLE = 'Değişkeni adlandır...';
/**
 * @const
 */
...
Blockly.Msg.RENAME_VARIABLE_TITLE = '"%1" değişkenin tümünü adlandır:';
 ...
 */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_STRING_VARIABLE = 'Metin değişkeni oluştur...';
/**
 * @const
 */
/// button text - Text on the button used to launch the variable creation dialogue.
...
Blockly.Msg.NEW_VARIABLE_DROPDOWN = 'Yeni değişken...';
/**
 * @const
 */
...
Blockly.Msg.NEW_VARIABLE_TYPE_DROPDOWN = '%1 yeni değişken...';
/**
 * @const
 */
/// prompt - Prompts the user to enter the type for a variable.
Blockly.Msg.NEW_VARIABLE_TYPE_TITLE = 'Yeni değişken türü:';
/**
 * @const
 */
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = 'tekrarla %1 defa';
/**
 * @const
 */
...
Blockly.Msg.IOS_VARIABLES_RENAME_BUTTON = 'Adlandır';
/**
 * @const
 */
 ...
 * @const
 */
/// tooltip - Describes the not equals (â‰ ) block.
 ...
 * @const
 */
/// tooltip - Describes the less than or equals (â‰¤) block.
 ...
 * @const
 */
/// tooltip - Describes the greater than or equals (â‰¥) block.
...
Blockly.Msg.LOGIC_NEGATE_TITLE = 'değilse %1';
/**
 * @const
 */
 ...
 * @const
 */
/// {{Optional}} url - Information about the mathematical constants Pi (Ï€), e, the golden ratio (Ï†), âˆš 2, âˆš 1/2, and infinity (âˆž).
 ...
 * @const
 */
/// dropdown - A number is [https://en.wikipedia.org/wiki/Prime prime] if it cannot be evenly divided by any positive integers except for 1 and itself.  For example, 5 is prime, but 6 is not because 2 Ã— 3 = 6.
